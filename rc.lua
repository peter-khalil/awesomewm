...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "🯱", "🯲", "🯳", "🯴", "🯵", "🯶", "🯷", "🯸", "🯹", "🯰" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	---	Pomodoro
    awful.key({ modkey,           }, "p",	function () awful.spawn(pomodoro) end,
              {description = "launch a pomodoro app",	group = "launcher"}),
	---	Streaming: FreeTube
    awful.key({ modkey,           }, "y",	function () awful.spawn(youtube) end,
              {description = "launch YouTube through FreeTube",	group = "launcher"}),
...
-- Autostart
awful.spawn.with_shell("numlockx")						-- Autostart Numlock
awful.spawn.with_shell("nitrogen --restore")			-- Wallpapers
awful.spawn.with_shell("kdeconnect-indicator")			-- KDE Connect Indicator
awful.spawn.with_shell("xmodmap -e 'pointer = 3 2 1'")	-- swap mouse buttons
